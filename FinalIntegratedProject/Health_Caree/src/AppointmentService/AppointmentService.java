...
public class AppointmentService {
	...
	public String readAppointment()
	 {
	 return patientObj.readAppointment();
	 }
	...
	public String insertAppointment(@FormParam("patient_nic") String patient_nic,
	...
	{
	 String output = patientObj.createAppoitnment(patient_nic, DoctorSpec, Doctor, Date,Time,hospital);
	return output;
	}
	...
	//Read the values from the JSON object
	 ...
	 String output = patientObj.updateAppoitnment(appointmentNum, date, hospital, time);
	return output;
	}
	...
	//Read the value from the element <itemID>
	 ...
	 String output = patientObj.deletePatient(appointId);
	return output;
	}
